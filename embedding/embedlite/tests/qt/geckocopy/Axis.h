...
public:
   ...
   */
  void UpdateWithTouchAtDevicePoint(int32_t aPos, const float& timeDelta);
   ...
   */
  float GetDisplacementForDuration(float aScale, const float& aDelta);
   ...
   */
  bool FlingApplyFrictionOrCancel(const float& aDelta);
